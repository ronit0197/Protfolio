...
export default function Home() {
  return (
    <>
      ...
      <div className="devider p-5 mt-10 flex justify-center items-center">
        <div className="bg-slate-300 rounded-full h-[15px] w-[15px]">
        </div>
        <div className="bg-slate-300 rounded-full h-[15px] w-[15px] mx-3">
        </div>
        <div className="bg-slate-300 rounded-full h-[10px] w-[70%]">
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto mt-5 sm:mt-20">
          <h1 className="text-center text-2xl sm:text-5xl mt-3 sm:mt-5 text-slate-700 font-extrabold underline decoration-slate-300">About Me</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-2">
            <div className="p-3 sm:p-10 text-center sm:text-left">
